...
const downloadEKSCFTYAML = async () => {
  const CFT_S3_URL = process.env.REACT_APP_EKS_CF_TEMPLATE_URL;
  ...
  try {
    ...
    if (response.ok) {
      ...
      link.href = url;
      link.download = "eks-cloudformation.yaml";
      link.click();
            ...
            <div className="flex-1 flex flex-col items-center space-y-6">
              ...
              <div className="flex flex-col items-center space-y-2">
                ...
                <Button
                  ...
                  onClick={() => {
                    const url = process.env.REACT_APP_EKS_CF_URL;
                    if (url) {
        ...
        >
          ...
          <Form.Item
            ...
            rules={[
              ...
              {
                pattern: /^arn:aws:iam::\d{12}:role\/Sec360-EKS-Role$/,
                message:
                  "Role ARN must be in the format arn:aws:iam::[12-digit-account-id]:role/Sec360-EKS-Role",
              },
              // {
              //   validator: (_, value) => {
  ...
  const handleSubmit = async () => {
    ...
    const account_id_from_role_arn =
      values3.role_arn.match(
        /^arn:aws:iam::(\d{12}):role\/Sec360-EKS-Role$/
      )[1] || "";
        ...
        <div className="mt-6 flex justify-between">
          ...
          {current < steps.length - 1 ? (
            ...
            <Button
              ...
              className={`!bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 !text-white hover:!text-white !border-0 font-semibold px-6 py-2 h-auto rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 ${isDoneDisabled ? "opacity-70" : ""
                }`}
...
export default EKSRoleCreation;
