...
import { Button, Steps, Input, Form } from "antd";
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-40 z-50 flex items-center justify-center">
      <div className="bg-white w-2/3 max-h-[90vh] overflow-y-auto p-6 relative bg-white/95 dark:bg-slate-900/95 backdrop-blur-lg rounded-2xl shadow-2xl shadow-slate-900/20 border border-slate-200 dark:border-slate-700">
        ...
        <div>
          <GetNote note="Enter your Azure Subscription ID. The Service Principal credentials are configured on the backend." />
        </div>
        ...
        <div className="bg-slate-50/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-xl border border-slate-200 dark:border-slate-700 p-6 mt-4 shadow-xl shadow-indigo-500/10">
          <Form form={form} layout="vertical">
            <Form.Item
              ...
              rules={[
                { required: true, message: "Please enter your Subscription ID!" },
              ]}
            >
              <Input
                placeholder="e.g. a2b28c85-1948-4263-90ca-bade2bac4df4"
                className="h-12 rounded-xl w-full dark:text-white border-slate-500 dark:border-slate-600 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm hover:border-blue-300 focus:border-blue-500 transition-all duration-200"
              />
            </Form.Item>
            ...
            >
              <Input
                placeholder="e.g. 4dbe5f90-7914-4e24-bc2f-2666eed5dd31"
                className="h-12 rounded-xl w-full dark:text-white border-slate-500 dark:border-slate-600 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm hover:border-blue-300 focus:border-blue-500 transition-all duration-200"
              />
            </Form.Item>
            ...
            <Form.Item
              ...
              rules={[
                { required: true, message: "Please enter your Client ID!" },
              ]}
            >
              <Input
                placeholder="e.g. 9c7beabf-44e8-481c-adcd-a452c6877561"
                className="h-12 rounded-xl w-full dark:text-white border-slate-500 dark:border-slate-600 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm hover:border-blue-300 focus:border-blue-500 transition-all duration-200"
              />
            </Form.Item>
            ...
            <Form.Item
              ...
              rules={[
                { required: true, message: "Please enter your Client Secret!" },
              ]}
            >
              <Input.Password
